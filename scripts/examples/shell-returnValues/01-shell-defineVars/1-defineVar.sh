...
echo "Properties defined in previous steps:"
...
echo "Preparing return file with properites..."
echo "SF_SR_VAR_TEST1=aaa" >> $RETURN_PROPERTIES_FILE
echo "SF_SR_VAR_TEST2='bbb ccc'" >> $RETURN_PROPERTIES_FILE
echo "SF_SR_VAR_TEST3='This is the last line!'" >> $RETURN_PROPERTIES_FILE


echo "Generated return file with properties:"
cat $RETURN_PROPERTIES_FILE
